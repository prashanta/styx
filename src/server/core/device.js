...
class Device{
    ...
    run(force){
        ...
        // })
        .catch(Errors.NetworkNotConnected, function(error){
            logger.error(error.message);
        })
        .catch(Errors.ServerNotFound, function(error){
            logger.error(error.message);
        })
        .catch(Errors.TokenNotValid, function(error){
            logger.error(error.message);
        })
        .catch(Errors.SerialPortFault, function(error){
            logger.error(error.message);
        })
